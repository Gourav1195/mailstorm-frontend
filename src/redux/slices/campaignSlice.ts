...
export const loadCampaigns = createAsyncThunk(
  "campaigns/load",
  async ({ search, status, type, startDate, endDate, sortBy, order, page, limit }: any) => {
...
const campaignSlice = createSlice({
  ...
  reducers: {
    ...
    setSelectedCampaignData: (state, action: PayloadAction<CampaignData>) => {
      state.selectedCampaign = action.payload;
    },
    setAudienceName(state, action: PayloadAction<string>) {
...
export const { updateCampaignList, setSelectedCampaignData, setAudienceName  } = campaignSlice.actions;
