                    ...
                    <CardContent>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid size={5}>
                                ...
                                <Typography>{audienceName1}</Typography>
                            </Grid>
                            <Grid size={7}>
                            ...
                            {campaignData.schedule && campaignData.type !== "Real Time" && (
                                <Grid size={5}>
                                    ...
                                    <Typography>{campaignData.schedule?.frequency} At &nbsp;
                                        {String(campaignData.schedule?.time)}, {campaignData.type === 'Criteria Based' ? "starts on" : "launch on" } {String(campaignData.schedule?.startDate).slice(0, 10)}.<br />

                                    </Typography>
                                    {campaignData.schedule?.endDate && campaignData.type === 'Criteria Based' ? (<Typography> Ends on {String(campaignData.schedule?.endDate).slice(0, 10)}</Typography>) : <></>
                                    }
                                </Grid>
                            )}
